...
import Cartao from '../../assets/images/card.png'
      ...
      {isSuccess ? (
        <Card title="Muito obrigado">
          <>
            <p>
              ...
              sucesso!<br></br>
              Abaixo estão os detalhes da sua compra:<br></br> Número do pedido:
              {data.orderId}
              <br></br> Forma de pagamento:
              {payWithCard ? 'Cartão de crédito' : ' Boleto Bancário'}
            </p>

            <p className="margin-top">
              Caso tenha optado pelo pagamento via boleto bancário, lembre-se de
              que a confirmação pode levar até 3 dias úteis.<br></br> Após a
        ...
        <form onSubmit={form.handleSubmit}>
          ...
          <Button
            ...
            title="clique aki para finalizar a compra"
          >
            Finaliza compra
          </Button>
        </form>
